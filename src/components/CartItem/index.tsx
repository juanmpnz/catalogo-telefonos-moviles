...
const CartItem: React.FC<CartItemProps> = ({ phone, onDelete }) => {
  const componentText = typeof componentTextRaw === 'object' ? componentTextRaw : JSON.parse(componentTextRaw as unknown as string);
  ...
  return (
    <div className='cart-item'>
      <div className='cart-item--image'>
        <Image src={secureImageUrl} alt={`${phone.brand} - ${phone.colorName}`} width={312} height={257} priority style={{ objectFit: 'contain' }} />
      </div>
      <div>
